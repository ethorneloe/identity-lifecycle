$Scenarios = @(
    ...
    $(
        ...
        @{
            ...
            Accounts = @(
                New-MonthlyTestAccount -SamAccountName $sam -UPN $upn -InactiveDaysAgo 90
            )
            ADUsers = @{
...
"@)
    ...
    $(
        ...
        @{
            ...
            Accounts = @(
                New-MonthlyTestAccount -SamAccountName $sam -UPN $upn -InactiveDaysAgo 89
            )
            ADUsers = @{
                $sam = New-MonthlyADUser -SamAccountName $sam -UPN $upn `
...
"@)
    ...
    $(
        ...
        @{
            ...
            Accounts = @(
                New-MonthlyTestAccount -SamAccountName $sam -UPN $upn -InactiveDaysAgo 120
            )
            ADUsers = @{
                $sam = New-MonthlyADUser -SamAccountName $sam -UPN $upn `
...
"@)
    ...
    $(
        ...
        @{
            ...
            Accounts = @(
                New-MonthlyTestAccount -SamAccountName $sam -UPN $upn -InactiveDaysAgo 150
            )
            ADUsers = @{
                $sam = New-MonthlyADUser -SamAccountName $sam -UPN $upn `
...
"@)
    ...
    $(
        ...
        @{
            ...
            Accounts = @(
                New-MonthlyTestAccount -SamAccountName $sam -UPN $upn -InactiveDaysAgo 180
            )
            ADUsers = @{
                $sam = New-MonthlyADUser -SamAccountName $sam -UPN $upn `
