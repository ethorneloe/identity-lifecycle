    ...
    $(
        ...
        @{
            ...
            ADUsers = @{
                ...
                $ownerSam = New-MonthlyADUser -SamAccountName $ownerSam -UPN $ownerEmail `
    ...
    $(
        ...
        @{
            ...
            ADUsers = @{
                ...
                $ea14Sam   = New-MonthlyADUser -SamAccountName $ea14Sam -UPN $ea14Email `
                    -EmailAddress $ea14Email -Enabled $true -WhenCreatedDaysAgo 1000
                $prefixSam = New-MonthlyADUser -SamAccountName $prefixSam -UPN $prefixEmail `
...
"@)
    ...
    $(
        ...
        @{
            ...
            Accounts = @(
                New-MonthlyTestAccount -SamAccountName $sam1 -UPN $upn1 -InactiveDaysAgo 95
                New-MonthlyTestAccount -SamAccountName $sam2 -UPN $upn2 -InactiveDaysAgo 95
            )
            ADUsers = @{
                ...
                $ownerSam1 = New-MonthlyADUser -SamAccountName $ownerSam1 -UPN $ownerEmail1 `
