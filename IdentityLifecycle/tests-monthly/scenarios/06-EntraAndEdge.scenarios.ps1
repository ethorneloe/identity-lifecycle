$Scenarios = @(
    ...
    $(
        ...
        @{
            ...
            ADUsers = @{}
            MgUsers = @{
                $oid.ToLower() = New-MonthlyMgUser -ObjectId $oid -AccountEnabled $true -LastSignInDaysAgo 30
            }
...
"@)
    ...
    $(
        ...
        @{
            ...
            ADUsers = @{}
            MgUsers = @{
                $oid.ToLower() = New-MonthlyMgUser -ObjectId $oid -AccountEnabled $true -LastSignInDaysAgo 95
            }
            AssertAfterRun = [scriptblock]::Create(@"
                param(`$result, `$ctx)
    ...
    $(
        ...
        @{
            ...
            MgUsers = @{
                ...
                $oid.ToLower() = New-MonthlyMgUser -ObjectId $oid -AccountEnabled $true -LastSignInDaysAgo 40
            }
            AssertAfterRun = [scriptblock]::Create(@"
                param(`$result, `$ctx)
    ...
    $(
        ...
        @{
            ...
            MgUsers = @{
                ...
                $oid.ToLower() = New-MonthlyMgUser -ObjectId $oid -AccountEnabled $true -LastSignInDaysAgo 180
            }
            AssertAfterRun = [scriptblock]::Create(@"
                param(`$result, `$ctx)
...
"@)
    ...
    $(
        ...
        @{
            ...
            DeleteThreshold  = 90
            Accounts         = @(
                New-MonthlyTestAccount -SamAccountName $sam -UPN $upn -InactiveDaysAgo 35
            )
            ADUsers          = @{
                $sam = New-MonthlyADUser -SamAccountName $sam -UPN $upn `
