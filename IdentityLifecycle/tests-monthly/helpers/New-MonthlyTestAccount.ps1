function New-MonthlyTestAccount {
    <#
    .SYNOPSIS
        Creates a CSV-shaped input row for Invoke-MonthlyInactiveAccountSweep tests.

    .PARAMETER SamAccountName
        AD SAM account name.

    .PARAMETER UPN
        User principal name (primary key in the monthly sweep).
...
function New-MonthlyADUser {
    <#
    .SYNOPSIS
        Creates a fake ADUser object for the Get-ADUser mock in monthly sweep tests.
...
function New-MonthlyMgUser {
    <#
    .SYNOPSIS
        Creates a fake MgUser object for the Get-MgUser mock in monthly sweep tests.
