function New-RemediationADAccount {
    <#
    .SYNOPSIS
        Creates a fake object matching Get-PrefixedADAccounts output for Remediation sweep tests.
...
function New-RemediationEntraAccount {
    <#
    .SYNOPSIS
        Creates a fake object matching Get-PrefixedEntraAccounts output for Remediation sweep tests.
...
function New-RemediationOwnerADUser {
    <#
    .SYNOPSIS
