$Scenarios = @(
    ...
    $(
        ...
        @{
            ...
            ADAccountList = @(
                New-RemediationADAccount -SamAccountName $sam -UPN $upn -LastLogonDaysAgo 90 -WhenCreatedDaysAgo 300
            )
            ADUsers  = @{
...
"@)
    ...
    $(
        ...
        @{
            ...
            ADAccountList = @(
                New-RemediationADAccount -SamAccountName $sam -UPN $upn -LastLogonDaysAgo 89 -WhenCreatedDaysAgo 300
            )
            AssertAfterRun = [scriptblock]::Create(@"
                param(`$result, `$ctx)
...
"@)
    ...
    $(
        ...
        @{
            ...
            ADAccountList = @(
                New-RemediationADAccount -SamAccountName $sam -UPN $upn -LastLogonDaysAgo 120 -WhenCreatedDaysAgo 300
            )
            ADUsers  = @{
                $std = New-RemediationOwnerADUser -SamAccountName $std -EmailAddress "$std@corp.local"
            }
...
"@)
    ...
    $(
        ...
        @{
            ...
            ADAccountList = @(
                New-RemediationADAccount -SamAccountName $sam -UPN $upn -LastLogonDaysAgo 150 -WhenCreatedDaysAgo 400
            )
            ADUsers  = @{
                $std = New-RemediationOwnerADUser -SamAccountName $std -EmailAddress "$std@corp.local"
            }
...
"@)
    ...
    $(
        ...
        @{
            ...
            ADAccountList = @(
                New-RemediationADAccount -SamAccountName $sam -UPN $upn -LastLogonDaysAgo 180 -WhenCreatedDaysAgo 500
            )
            ADUsers  = @{
                $std = New-RemediationOwnerADUser -SamAccountName $std -EmailAddress "$std@corp.local"
            }
    ...
    $(
        ...
        @{
            ...
            ADAccountList = @(
                ...
                New-RemediationADAccount -SamAccountName $sam -UPN $upn -LastLogonDaysAgo -1 -WhenCreatedDaysAgo 95
            )
            ADUsers  = @{
                $std = New-RemediationOwnerADUser -SamAccountName $std -EmailAddress "$std@corp.local"
            }
...
"@)
    ...
    $(
        ...
        @{
            ...
            WarnThreshold  = 30
            ADAccountList  = @(
                New-RemediationADAccount -SamAccountName $sam -UPN $upn -LastLogonDaysAgo 35 -WhenCreatedDaysAgo 200
            )
            ADUsers  = @{
                $std = New-RemediationOwnerADUser -SamAccountName $std -EmailAddress "$std@corp.local"
            }
